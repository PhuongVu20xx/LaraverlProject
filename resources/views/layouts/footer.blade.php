...
<footer class="section-footer">
    <section class="footer-container1">
        <div>
            <ul>
                <li><a href="#"><h3>ONLINE ORDERS</h3></a></li>
        ...
        <div>
            <ul>
                <li><a href="#"><h3>24/7 CUSTOMER SERVICE</h3></a></li>
        ...
        <div>
            <ul>
                <li><a href="#"><h3>GRANDE'S BRIDAL STORES</h3></a></li>
        ...
        <div>
            <ul>
                <li><a href="#"><h3>ABOUT GRANDE'S BRIDAL</h3></a></li>
