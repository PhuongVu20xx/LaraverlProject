...
<head>
    ...
    <!-- Head Libs -->
		...
		<!-- <link rel="stylesheet" href="{{asset('css/admin/layout/adminform.css')}}" /> -->
        ...
        <div>
            ...
            <header class="header">
                <div class="logo-container">
                    <a href="#" class="logo">
                        <div src="#" height="35" alt="JSOFT Admin" />
                    </a>
...
@yield('scripts')
		...
		<script src="{{asset('octopus/octopus/assets/vendor/bootstrap/js/bootstrap.j')}}"></script>
		...
		<script src="{{asset('octopus/octopus/assets/vendor/jquery-placeholder/jquery.placeholder.js')}}"></script>
		
		<!-- Specific Page Vendor -->
		<script src="{{asset('octopus/octopus/assets/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js')}}"></script>
		...
		<!-- Theme Custom -->
		<script src="{{asset('octopus/octopus/assets/javascripts/theme.custom.js')}}"></script>
